            ...
            <div class="row align-items-center justify-content-lg-start justify-content-center flex-lg-nowrap">
                <div class="col-lg-5 col-12" data-cues="slideInDown" data-group="page-title" data-delay="700">
                    <div class="text-center text-lg-start" data-cue="zoomIn">
                        <div class="mb-5">
                            <span
                                class="badge align-items-center p-2 pe-3 ps-3 fs-6 text-primary border border-primary-subtle rounded-pill mb-4">
                                Custom Design</span>
                            <span
                                class="badge align-items-center p-2 pe-3 ps-3 fs-6 text-primary border border-primary-subtle rounded-pill mb-4">
                                UI - UX</span>
                            <h1 class="mb-3 display-4">Website & Eshop</h1>
                            <p class="lead mb-0">Κατασκευάζουμε ηλεκτρονικά καταστήματα και online εφαρμογές που εκτοξεύουν τις πωλήσεις σας...</p>
                        </div>
                        <div data-cues="slideInDown" data-group="page-title-buttons" data-delay="800">
                            <a href="/services" class="btn btn-primary me-2">ΥΠΗΡΕΣΙΕΣ</a>
                            <a href="/our-work" class="btn btn-light">ΤΑ ΕΡΓΑ ΜΑΣ</a>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-7 offset-xxl-1 col-lg-7 col-12 mt-5 mt-lg-0" data-cue="fadeIn" data-delay="1000">
                    <div class="position-relative">
                        ...
                        <div class="position-absolute top-50 mt-n10 start-0 ms-n4 d-none d-lg-block">
                            <div class="badge text-bg-info text-white-stablepx-3 py-2 fs-6 rounded-pill">Websites</div>
                        ...
                        <div class="position-absolute bottom-50 mb-n10 start-0 d-none d-lg-block">
                            <div class="badge text-bg-success text-white-stablepx-3 py-2 fs-6 rounded-pill">Ecommerce
                            </div>
                            <div class="position-absolute top-0 end-0 mt-n3 me-n3">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="position-absolute bottom-0 me-n8 end-0 d-none d-lg-block">
                            <div class="badge text-bg-danger text-white-stablepx-3 py-2 fs-6 rounded-pill">Custom Applications
                            </div>
                        ...
                        <div class="position-absolute top-0 mt-10 end-0 d-none d-lg-block">
                            <div class="badge text-bg-primary text-white-stablepx-3 py-2 fs-6 rounded-pill">Web Security</div>
                            <div class="position-absolute top-0 start-0 mt-n3 ms-n3">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
