...
@section('content')
    <script type="text/javascript"
        src="https://platform-api.sharethis.com/js/sharethis.js#property=662ca71aa65df900205b9556&product=sticky-share-buttons&source=platform"
        async="async"></script>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="d-grid gap-2 col-6 mx-auto mt-5">
                    <a href="/blog" class="btn btn-primary" type="button">ΕΠΙΣΤΡΟΦΗ</a>
                </div>
            </div>
        </div>
    </div>
